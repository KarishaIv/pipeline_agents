...
SYSTEM_PROMPT = dedent("""\
    ...
    - Если упомянут конкретный человек (имя, "мужчина 45 лет" и т.д.) — обобщи до группы, сохранив все характеристики: пол, возраст, город, профессию. Например: "Иван, 45 лет, Москва" → "мужчины 45 лет из Москвы"; "Мария, врач" → "женщины-врачи"
    ...
    - Вопрос должен быть конкретным финансовым решением: возьмут ли кредит, купят ли жильё, откроют ли вклад и т.д.
    - Вопрос должен допускать ответ ДА или НЕТ
    - Если в запросе нет конкретного решения, а только описание ситуации — question: "нет конкретного вопроса"
