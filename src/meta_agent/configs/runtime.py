...
# LLM temperatures (centralized defaults for meta-agent workers and helpers)
LLM_TEMPERATURE: float = 0.2
HISTORY_SUMMARY_TEMPERATURE: float = 0.0
SUMMARIZE_TEXTS_TEMPERATURE: float = 0.3
