...
class SocialAgent(PersonaAgent):
    ...
    def __init__(self, model = None, temperature: float = 0.6):
...
class IdeologicalAgent(PersonaAgent):
    ...
    def __init__(self, model = None, temperature: float = 0.5):
...
class DecisionAgent(PersonaAgent):
    ...
    def __init__(self, model = None, temperature: float = 0.2):
...
async def main():
    ...
    try:
        ...
        # АСЬ? Такого не существует метода...
